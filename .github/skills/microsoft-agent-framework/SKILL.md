...
- **Memory**: Cosmos DB for canonical agent sessions and conversation ownership boundaries (see `docs/specs/agent-sessions.md` and `docs/specs/conversations-state-model.md`)
